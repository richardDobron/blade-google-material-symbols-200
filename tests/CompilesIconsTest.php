...
use dobron\BladeMaterialSymbols\BladeGoogleMaterialDesignSymbols200ServiceProvider;
...
class CompilesIconsTest extends TestCase
{
    ...
    {
        $result = svg('gms:200-fact_check-fill-outlined')->toHtml();
        $this->assertMatchesXmlSnapshot($result);
    }

    public function testIconContainsClasses()
    {
        $result = svg('gms:200-done_outline-fill-outlined', 'w-6 h-6 text-gray-500')->toHtml();
        $this->assertMatchesXmlSnapshot($result);
    }

    public function testIconContainsStyles()
    {
        $result = svg('gms:200-wb_sunny-fill-sharp', ['style' => 'color: #555'])->toHtml();
        $this->assertMatchesXmlSnapshot($result);
    }
    ...
    protected function getPackageProviders($app): array
    {
        return [
            ...
            BladeGoogleMaterialDesignSymbols200ServiceProvider::class,
        ];
    }
}
